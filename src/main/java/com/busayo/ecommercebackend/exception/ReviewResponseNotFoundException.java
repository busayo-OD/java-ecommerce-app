...
public class ReviewResponseNotFoundException extends EcommerceAPIException{
    private static final long serialVersionUID = 1L;
    public static final String ENTITY_NAME = "ReviewResponse";
    private Object entityId = null;

    public ReviewResponseNotFoundException(Object entityId) {
